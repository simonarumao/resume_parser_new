...
submit2 = st.button("read job description")
...
input_prompt2 = """You are an AI language model. Analyze the following job description and summarize the key skills, qualifications, and responsibilities required """

input_prompt4 = """You are an AI resume evaluator. Compare the candidate's resume with the provided job description.
1. Gaps Identified: List the key areas where the resume falls short compared to the job description"""
